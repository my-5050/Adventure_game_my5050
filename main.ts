...
let enemies:string[]=["Skeleton","granny","Mr'Meet","Assasin"];
let maxenemyhealth : number =75
let enemy_attakdemagetohero:number=25

// ''''''''''''''''''''''''''''''''hero detail'''''''''''''''''''''''''''''''''''''''

let maxherohealth: number =100
let hero_attackdemagetoenemy :number=50;
let hero_lives:number=3
let hero_livesfillingamount:number=30
let enemy_death_amount:number=50
